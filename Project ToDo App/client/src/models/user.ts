...
export const list: User[] = [
    {
        ...
        userTasks: [
            ...
            {task : 'Need to update Rest service',dueDate:'06/11/2022', isCompleted: false, assignedBy: "Harika"},
            {task : 'Need to update Async',dueDate:'04/17/2022', isCompleted: false, assignedBy: "Onepiece"},
    ...
    },
    {
        ...
        userTasks: [
            ...
            {task : 'Need to update CSS',dueDate:'04/30/2022', isCompleted: false, assignedBy: "Harika"},
            {task : 'Need to update Web Service',dueDate:'03/31/2022', isCompleted: false, assignedBy: "Yash"}
        ]
        //
    },
    {
        ...
        userTasks: [
            ...
            {task : 'Need to update Services',dueDate:'07/26/2022', isCompleted: false, assignedBy: "Yash"},
            {task : 'Need to update Python',dueDate:'03/22/2022', isCompleted: false, assignedBy: "Yash"},
    ...
    },
    {
        ...
        userTasks: [
            {task : 'Need to update Vue',dueDate:'20/05/2022', isCompleted: false, assignedBy: "Sakshi"},
    ...
    },
    {
        ...
        userTasks: [
            {task : 'Need to update Vue',dueDate:'04/09/2022', isCompleted: false, assignedBy: "Sakshi"},
            {task : 'Need to update ajax',dueDate:'06/25/2022', isCompleted: false, assignedBy: "Niha"}
        ]
    }
]
